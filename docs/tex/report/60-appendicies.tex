\begin{appendices}
    ...
    \listingfile{netpmod.c}{int-usb-2}{C}{Функции для работы со списком устройств}{linerange={166-189}}
    ...
    \listingfile{netpmod.c}{usb-insert}{C}{Обработчик подключения USB--устройства}{linerange={191-212}}

	\newpage

    \listingfile{netpmod.c}{usb-remove}{C}{Обработчик удаления USB--устройства}{linerange={214-235}}

    \chapter{Обработчик клавиатуры}
    
    \listingfile{netpmod.c}{kbd-data}{C}{Объявление используемых значений}{linerange={262-264}}

    \listingfile{netpmod.c}{kbd-verify-action}{C}{Функция валидации события}{linerange={265-276}}
    
    \listingfile{netpmod.c}{kbd-verify-pwd-len}{C}{Функция валидации пароля}{linerange={278-288}}
    
    
    \clearpage

    \listingfile{netpmod.c}{kbd-action}{C}{Функция обработки символа }{linerange={290-309}}
